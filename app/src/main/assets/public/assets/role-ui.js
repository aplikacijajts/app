(function () {
  const PUBLIC_PAGES = new Set(["/", "/home.html", "/index.html", "/register.html"]);
  const ROLE_HOME = {
    admin: "/admin.html",
  ...
  const PAGE_ROLES = {
    ...
    "/gps.html": ["admin", "dispatcher", "driver"],
    "/live-map.html": ["admin", "dispatcher", "driver"],
  ...
  function getToken() {
    return localStorage.getItem("token") || localStorage.getItem("jts_token") || localStorage.getItem("authToken") || "";
  }
  ...
  function currentUser() {
    ...
    const normalized = { id: u.sub || u.id, name: u.name || "User", role: u.role, companyId: u.companyId || "jts-logistics", exp: u.exp };
    try {
